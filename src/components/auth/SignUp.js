      ...
      <div className="signin">
        ...
        <div className="row email-row">
          ...
          <div className="pwd-wrapper">
            ...
            <input type="password" id="repeat-password" name="repeat-password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
          </div>
        </div>
        ...
        <p className="signup-link">Don't have an account? <Link to="/signin">Sign in</Link></p>
      </div>
      <ToastContainer
        position="top-right"
        autoClose={5000}
